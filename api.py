...
@app.get("/shopee/auth/oauth2/link", tags=[SHOPEE_OAUTH2])
...
@app.get("/shopee/auth/oauth2/callback", tags=[SHOPEE_OAUTH2])
...
@app.post("/shopee/auth/oauth2/token", tags=[SHOPEE_OAUTH2])
...
@app.post("/shopee/auth/oauth2/refreshToken", tags=[SHOPEE_OAUTH2])
...
@app.get("/shopee/token", tags=[SHOPEE_OAUTH2])
...
@app.post("/corteza/auth/oauth2/token", tags=[CORTEZA_OAUTH])
...
@app.get("/corteza/token", tags=[CORTEZA_OAUTH])
